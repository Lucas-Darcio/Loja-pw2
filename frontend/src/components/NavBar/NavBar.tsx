  ...
  return (
    <Navbar fluid rounded>
      <NavbarBrand as={Link} href="https://flowbite-react.com">
        <Image width={50} height={50} src="/next.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite React Logo" />
      ...
      <NavbarCollapse>
        ...
        { user && <NavbarLink as={Link} onClick={handleLogout} href="#">Logout</NavbarLink>}
